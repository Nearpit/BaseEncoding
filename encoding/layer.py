...
class IntegerBaseEncoder(layers.Layer):
    def __init__(self, base=2, norm=True, max_column_width=32):
        ...
        self._padding_func = np.vectorize(
            lambda x: x.zfill(self.max_column_width-1))
...
class FloatBaseEncoder(IntegerBaseEncoder):
    ...
    def _frexp(self, inputs):
        ...
        The sign is transferred from mantissa to exponent for the sake of the parent class integrity. 
        """
